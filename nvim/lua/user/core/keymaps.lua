...
local opts = { noremap = true, silent = true } -- No remapping and don't show command message in command line.
...
vim.keymap.set("n", "<Esc>", ":nohlsearch<CR>", {
	silent = true,
	noremap = true,
	desc = "Quit highlighting of search.",
})

vim.keymap.set("n", "n", "nzzzv", {
	silent = true,
	noremap = true,
	desc = "Center the screen after jumping to the next match.",
})
...
vim.keymap.set(
	...
	"N",
	"Nzzzv",
	{ desc = "Center the screen after jumping to the previous match.", silent = true, noremap = true }
)
...
vim.keymap.set("n", "vv", "V", { desc = "Enter visual line mode like all other line commands." })
vim.keymap.set("n", "vb", "<C-v>", { desc = "Enter visual block mode (vb)." })
...
vim.keymap.set("n", "L", "<C-w>l", { desc = "Go to right split (L)." })
vim.keymap.set("n", "H", "<C-w>h", { desc = "Go to left split (H)." })
vim.keymap.set("n", "J", "<C-w>j", { desc = "Go to split below (J)." })
vim.keymap.set("n", "K", "<C-w>k", { desc = "Go to split above (K)." })
