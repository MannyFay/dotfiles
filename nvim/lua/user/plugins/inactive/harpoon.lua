...
-- For quick navigation between tagged files.
-------------------------------------------------------------------------------
...
return {
	...
	config = function()
		...
		vim.keymap.set("n", "<Leader>hs5", function()
			harpoon:list():select(5)
		end)
		vim.keymap.set("n", "<Leader>hs6", function()
			harpoon:list():select(6)
		end)
		vim.keymap.set("n", "<Leader>hs7", function()
			harpoon:list():select(7)
		end)
		vim.keymap.set("n", "<Leader>hs8", function()
			harpoon:list():select(8)
		end)
		vim.keymap.set("n", "<Leader>hs9", function()
